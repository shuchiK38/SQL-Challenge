...
SELECT departments_employee.dept_no, employee.emp_no, employee.last_name, employee.first_name
FROM departments_employee
JOIN employee
ON departments_employee.dept_no = employee.emp_no
...
SELECT last_name,
COUNT(len(last_name)) AS "frequency"
FROM employee
GROUP BY last_name
